...
const dictEn: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.dynamicFontSizeHint': 'Automatically adjust font size to fit the field.',
...
const dictPl: { [key in keyof Dict]: string } = {
  ...
  'schemas.text.dynamicFontSizeHint': 'Automatycznie dopasuj rozmiar czcionki, aby tekst zmieścił się w polu.',
  'schemas.text.format': 'Format',
